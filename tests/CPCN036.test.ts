...
test('CPCN036', async ({ page }) => {
    ...
    await page.locator("//html/body/div[1]/div[2]/div[3]/div[1]/div[6]/form/div[2]/div/div[3]/div[1]/div[1]/div[2]/div/div[3]/div[1]/p[1]/input").click();
    await page.locator("//html/body/div[1]/div[2]/div[3]/div[1]/div[6]/form/div[2]/div/div[3]/div[1]/div[1]/div[2]/div/div[3]/div[1]/p[1]/input").fill('-0.01');
    await page.getByRole('button', { name: 'Publish', exact: true }).click();

    await page.getByRole('link', { name: 'Shipping' }).click();
    await expect(page.locator("//html/body/div[1]/div[2]/div[3]/div[1]/div[6]/form/div[2]/div/div[3]/div[1]/div[1]/div[2]/div/div[3]/div[1]/p[1]/input")).toHaveValue('');
